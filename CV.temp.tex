...
\begin{itemize}
\setlength\itemsep{0ex}
\item Current (total) advisees: 5 (16) postdoc, 5 (6) graduate, 4 (27) undergraduate
\item Current thesis committees: 23 PhD, ? MS
...
\item Science Career presentation, Fred T. Korematsu Elementary School, Davis
\item Maize Genetics Awards Committee, 2017
\item Advisory Board, PeerJ Preprints, 2016-present
\item Editorial Boards: Genes, Genomes, and Genetics (Associate Editor 2014-2016, Senior Editor 2017-present), \emph{PeerJ} (2013-present), Axios Reviews (2013-2017), Peer Community in Evolutionary Biology (2017-present), eLife (Guest Editor, 2016)
...
\item Journal peer review: \ignore{7/15,6/16,7/16,12/16,2/17} Nature (5), \ignore{4/16} Nature Genetics,
\ignore{10/16} eLife, \ignore{6/15,7/15,1/16}  Nature Plant (3), \ignore{5/15,6/16} PLoS Genetics (2), \ignore{6/17} The Plant Cell, \ignore{6/16} eLife, \ignore{9/15} Current Biology, \ignore{9/15,6/15,7/15} Molecular Biology \& Evolution (3), \ignore{1/16, 2/16,7/16} Genome Research (3), \ignore{7/15} Genetics, \ignore{9/15,6/16} Trends in Plant Science (2), \ignore{6/15,1/17} Genome Biology \& Evolution (2),  \ignore{1/15,11/16,2/17,5/17} Molecular Ecology (4), \ignore{6/15} G3 (many), \ignore{1/17} BMC Genomics, \ignore{6/15} PLoS ONE, \ignore{12/16} Scientific Reports
...
%\ignore{5/15} Molecular Bilogy and Evolution
%\ignore{12/14} Genome Bilogy and Evolution

%\ignore{7/13} Scientific Reports
%\ignore {3/13} Economic Botany,
%\ignore{4/13} PLoS Biology,
%\ignore{4/13,1/15} PLoS One,
...
\begin{itemize}
  ...
  %\item Dawe RK, Lowry EG, Gent J, {\bf Stitzer MC}, Higgins DM, {\bf Ross-Ibarra J}, Wallace JG, Kanizay L, Alabady M, Wang N, Gao Z, Birchler J, Harkess AE, Hodges AL, Hiatt EN. A novel maize kinesin causes neocentromere activity and meiotic drive, altering inheritance patterns across the genome

\item \textbf{Bilinski P}, Albert P, Berg JJ, Birchler JA, Grote M, \textbf{Lorant A}, \textbf{Quezada J$^\ddagger$}, Swarts, K, \textbf{Yang J}, \textbf{Ross-Ibarra J$^\S$}
...
\href{https://doi.org/10.1101/114579}{The interplay of demography and selection during maize domestication and diffusion}
...
\item \textbf{Lorant A}, Pedersen S, Holst I, Hufford MB, Winter K, Piperno D, \textbf{Ross-Ibarra J$^\S$} (2017) \textsc{PLoS ONE} \textit{In Press}
\href{https://doi.org/10.1101/105940}{The potential role of genetic assimilation during maize domestication}

\item Aguilar-Rangel MR, Chávez Montes RA,  Gonzalez-Segovia E, \textbf{Ross-Ibarra J}, Simpson JK, Sawers RJH (2017) \textsc{PeerJ} \textit{In Press}
Allele specific expression analysis identifies regulatory variation associated with stress-related genes in the Mexican highland maize landrace Palomero Toluque\~{n}o


\item   \textbf{Stetter MG}, \textbf{Gates DJ}, \textbf{Mei W}, \textbf{Ross-Ibarra J$^\S$} (2017) \textsc{Current Biology} \textit{In Press} \href{https://peerj.com/preprints/2902/}{How to make a domesticate}

\item Genomic estimation of complex traits reveals ancient maize adaptation to temperate North America (2017) Swarts K, Gutaker RM,   Schuenemann V,  Benz B,  Blake M, Bukowski R, Holland J, Kruse-Peeples M, Lepak N, Matson RG, Prim L, Romay C, {\bf Ross-Ibarra J}, Sanchez J, Schmidt C,  Sofro E,  Krause J,  Weigel D,  Buckler ES,  Burbano HA \textsc{Science} \textit{In Press}
