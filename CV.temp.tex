...
\item Search committees: Dept. Chair of Plant Sciences (Chair, 2016), Director Genome Center Sequencing Core (2014)
% search committees: Science Writer (2012), Pop/Quant Geneticist (2012), Bioinformatician (chair, 2013), Director Plant Breeding Center (2013)
...
% \item 2017 Maize Genetics Awards Committee
...
\begin{etaremune}
\setlength\itemsep{0ex}
\item {\bf Velasco D}, Aradhya M, and  and {\bf Ross-Ibarra J$^\S$} (2016) Evolutionary genomics of peach and almond domestication. \textsc{G3} \emph{In press}

\item Ramos-Madrigal J, Smith BD, Moreno-Mayar JV, Gopalakrishnan S, {\bf Ross-Ibarra J}, Gilbert MTP, Wales N (2016) Genome sequence of a 5310-year-old maize cob provides insights into the early stages of maize domestication. \textsc{Current Biology} \emph{In Press}

\item {\bf Durvasula A}$^\ddagger$$^*$,  Hoffman PJ$^*$, {\bf Kent TV}$^\ddagger$, Liu C, Kono TJY, Morrell PL$^\S$, {\bf Ross-Ibarra J}$^\S$ (2016) ANGSD-wrapper \textsc{Molecular Ecology Resources} \emph{In Press} %\href{https://peerj.com/preprints/1472/}{ANGSD-wrapper}
%CITES:0
