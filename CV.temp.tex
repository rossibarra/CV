...
\begin{itemize}
\setlength\itemsep{0ex}
\item Current (total) advisees: 3 (26) postdoc, 6 (11) graduate, 2 (34) undergraduate %check these numbers!
...
\item EEREC REU faculty advisor, 2022
...
\item Advisory Board, FOREVER project \hfill2021-present %- https://www.aka.fi/globalassets/1-tutkimusrahoitus/4-ohjelmat-ja-muut-rahoitusmuodot/1-akatemiaohjelmat/rlife/rlife-hanke-esittely-pyhajarvi_jpg_s_hires.pdf
...
\begin{etaremune}
\setlength\itemsep{0ex}
\item Hu H, Crow T, Nojoomi S, Schulz, AJ, Hufford MB, Flint-Garcia SF, Sawers RJ, Rell\`{a}n-\`{A}lvarez R, Est\`{e}vez-Palmas JM, \textbf{Ross-Ibarra J}, Runcie DE. Allele-specific expression reveals multiple paths to highland adaptation in maize. \textsc{Mol. Bio. Evol.} \textit{Accepted} 
%CITES: 0
...
\item \textbf{O'Brien A}$^\S$, Sawers R, \textbf{Ross-Ibarra J}, Strauss  SY$^\S$ (2018) Evolutionary responses to condition[0ality in species interactions across environmental gradients. \textsc{American Naturalist} 192(6): 715-730.
%CITES:3273742166310424316,15989762014020028899,1188360045255703991
