...
\item Search committees: Bioinformatician (chair), Science Writer, Director Plant Breeding Center, Pop/Quant Geneticist 2012-2014
...
\item Journal peer review (last 12 months): \ignore{8/13,10/13} Nature (2), \ignore {1/14, 3/14} Nature Genetics (2), \ignore{6/13,7/13,8/13} PNAS (3), \ignore{8/13} Current Biology, \ignore{3/13,4/14,4/14} PLoS Genetics (2), \ignore{7/13} Genome Research, \ignore {3/14} American Naturalist, \ignore{1/14} Molecular Ecology, \ignore{1/14} BMC Genomics, , \ignore{7/13} Scientific Reports, \ignore{9/13} Peerage of Science
...
\item {\bf Vann LE}, {\bf Kono T|}, {\bf Pyh\"aj\"arvi T}, {\bf Hufford MB}$^\S$, {\bf Ross-Ibarra J}$^\S$. Natural variation in teosinte at the domestication locus teosinte branched1 (tb1). 
