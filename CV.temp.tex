...
%				\item Arun Durvasula
%				\item BILINSKI STUDENT GROWTH RATE
%			\end {itemize}
...
%\item External expert review, Professorial candidate job search, Uppsaala University
...
\item Journal peer review: \ignore{7/15} Nature, \ignore{4/16} Nature Genetics, \ignore{6/15,7/15,1/16}  Nature Plant (3), \ignore{4/14,4/14,8/14,12/14,5/15} PLoS Genetics (5), \ignore{1/15} eLife, \ignore{9/15} Current Biology, \ignore{9/15,7/14,7/14,5/15,6/15,7/15} Molecular Biology \& Evolution (6), \ignore{1/16, 2/16} Genome Research (2), \ignore{7/15} Genetics, \ignore{9/2015} Trends in Plant Science, \ignore{12/14,6/15} Genome Biology \& Evolution (2),  \ignore{1/15} Molecular Ecology, \ignore{2/15,6/15} G3 (2), \ignore{10/14} BMC Biology, \ignore{1/15,6/15} PLoS ONE (2)
...
\item Wolfgruber TK, Nakashima MM, Schneider KL, Sharma A, Xie Z, Albert PS, Xu R, {\bf Bilinski P},  Dawe RK, {\bf Ross-Ibarra J}, Birchler JA, Presting G (2016) High quality maize centromere 10 sequence reveals evidence of frequent recombination events. \textsc{Frontiers In Plant Science} \emph{In Press}
%CITES:0

\item Orozco-Ram\`{i}rez Q, Santacruz-Varela A, {\bf Ross-Ibarra J}, Brush B (2016) Maize diversity associated with social origin and environmental variation in southern Mexico. \textsc{Heredity} \emph{In Press}
