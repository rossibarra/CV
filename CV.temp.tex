...
\item Journal peer review: \ignore{6/16,7/16,12/16,2/17} Nature (4), \ignore{4/16} Nature Genetics,
\ignore{10/16} eLife, \ignore{1/16}  Nature Plant, \ignore{9/17} Cell, \ignore{9/17} Nature Communications,  \ignore{6/16} PLoS Genetics, \ignore{6/17} The Plant Cell, \ignore{6/16} eLife, \ignore{9/15} Current Biology, \ignore{9/15} Molecular Biology \& Evolution, \ignore{1/16, 2/16,7/16} Genome Research (3), \ignore{9/15,6/16} Trends in Plant Science (2), \ignore{1/17} Genome Biology \& Evolution,  \ignore{11/16,2/17,5/17} Molecular Ecology (3), G3 (many), \ignore{1/17} BMC Genomics, \gnore{9/17} Plant Journal, \ignore{12/16} Scientific Reports
...
\item {\bf Yang J$^*$}, {\bf Mezmouk S$^*$}, Baumgarten A, Buckler ES, Guill KE, McMullen MD, Mumm RH, {\bf Ross-Ibarra J$^\S$} (2017) Incomplete dominance of deleterious alleles contribute substantially to trait variation and heterosis in maize \textsc{PLoS Genetics} \textit{In Press}
