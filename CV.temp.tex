...
\newlength{\cvhang}\setlength{\cvhang}{3em}
...
\newcommand{\cvitem}[3][\cvhang]{%
  \item\begin{tabularx}{\dimexpr\linewidth+\cvhang\relax}{@{}>{\hangindent=#1\hangafter=1\raggedright\arraybackslash}X@{\hspace{3em}}r@{}}
    #2 & #3
  \end{tabularx}%
}
