...
\item Genetics (BIS 101, undergraduate), 2013-present
\item Ecological Genomics (ECS243, graduate), 2014-present
...
%\begin{itemize}
%\item UCMEXUS: Adaptive gene flow from teosinte to highland maize in central Mexico, 2015-20 (Co-PI, \$24,897 total)
%\item NSF Plant Genome: Biology of Rare Alleles (Co-PI, \$3.2M to JRI), 2013 - 2018
%\item NSF Plant Genome Research Program (Co-PI, \$754,409 to JRI, 2010 - 2016) 
...
\item {\bf Durvasula A}$^\ddagger$,  Hoffman PJ, {\bf Kent TV}$^\ddagger$, Liu C, Kono TJY, Morrell PL$^\S$, {\bf Ross-Ibarra J}$^\S$. ANGSD-wrapper.

\item {\bf Beissinger TM}$^\S$, Wang L, {\bf Crosby K}, {\bf Durvasula A}$^\ddagger$, Hufford MB, {\bf Ross-Ibarra J}$^\S$.  Recent demography drives changes in linked selection across the maize genome.  
