...
\item Editorial Boards: Genes, Genomes, and Genetics (AE 2014-present, SE 2017-present), Genetics (Guest, 2018), PLoS Genetics (2018-2019), PeerJ (2013-present, SE 2018-2019), Axios Reviews (2013-2017), PNAS (Guest, 2018), eLife (Guest, 2016)
\item Journal peer review:  \ignore{10/18,1/19} eLife (2),  \ignore{9/17} Cell, \ignore{9/17,4/18} Nature Communications, \ignore{2/19} Nature Reviews Genetics, \ignore{4/18,7/18,8/18} PNAS (3), \ignore{6/17} The Plant Cell,  \ignore{12/17} New Phytologist,  \ignore{5/17} Molecular Ecology, G3 (many),  \ignore{9/17} Plant Journal,  \ignore{11/17} Agriculture, Ecosystems and Environment
\item Proposal review: NSF (2017), DFG (2019)
...
%\ignore{1/14,1/15,1/15,11/16,2/17} Molecular Ecology
...
\item  Gonzalez-Segovia E,  P\'erez-Limon S,  C\'intora-Mart\'inez C,  Guerrero-Zavala A,  Jansen G,  Hufford MB, \textbf{Ross-Ibarra J}, Sawers RJH. Characterization of introgression from the teosinte \textit{Zea mays} ssp. \textit{mexicana} to Mexican highland maize. doi: 10.7287/peerj.preprints.27489v1
%CITES:0

\item   Anderson SN$^*$, \textbf{Stitzer MC}$^*$,  Brohammer A$^*$, Zhou P, Noshay JM,  Hirsch C,   Hirsch C,  Springer NM. Transposable elements contribute to dynamic genome content in maize. doi: 10.1101/547398
%CITES:0

\item \textbf{O'Brien AM}$^\S$, Sawers RJH, Strauss SY, \textbf{Ross-Ibarra J}$^\S$. Adaptive phenotypic divergence in teosinte differs across biotic contexts. doi: 10.1101/382770
%CITES:0
...
\item \textbf{Josephs EM}$^\S$, Berg JJ, \textbf{Ross-Ibarra J}, Coop G (2019) Detecting adaptive differentiation in structured populations with genomic data and common gardens. \textsc{Genetics} \textit{In Press}
%CITES:0
