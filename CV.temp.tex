...
% search committees: Science Writer (2012), Pop/Quant Geneticist (2012)
...
\item Journal peer review: \ignore{7/15,6/16} Nature (2), \ignore{4/16} Nature Genetics, \ignore{6/15,7/15,1/16}  Nature Plant (3), \ignore{8/14,12/14,5/15,6/16} PLoS Genetics (4), \ignore{1/15} eLife, \ignore{9/15} Current Biology, \ignore{9/15,7/14,7/14,5/15,6/15,7/15} Molecular Biology \& Evolution (6), \ignore{1/16, 2/16} Genome Research (2), \ignore{7/15} Genetics, \ignore{9/2015,6/16} Trends in Plant Science (2), \ignore{12/14,6/15} Genome Biology \& Evolution (2),  \ignore{1/15} Molecular Ecology, \ignore{2/15,6/15} G3 (2), \ignore{10/14} BMC Biology, \ignore{1/15,6/15} PLoS ONE (2)
\item Proposal review: Swiss National Science Foundation (2016), GWIS (2016), Israeli Science Foundation (2016)
...
%\item (pending) NSF Plant Genome Research Program: "The genetics of highland adaptation in maize" (PI, \$4.5M), 2016-2021
...
%\item {\bf Velasco D}, Aradhya M, and  and {\bf Ross-Ibarra J$^\S$}. Evolutionary genomics of peach and almond domestication
...
%\item Ramos-Madrigal J, Smith BD, Moreno-Mayar JV, Gopalakrishnan S, {\bf Ross-Ibarra J}, Gilbert MTP, Wales N.  Genome sequence of a 5310-year-old maize cob provides insights into the early stages of maize domestication
...
\item {\bf Durvasula A}$^\ddagger$$^*$,  Hoffman PJ$^*$, {\bf Kent TV}$^\ddagger$, Liu C, Kono TJY, Morrell PL$^\S$, {\bf Ross-Ibarra J}$^\S$. (2016) ANGSD-wrapper \textsc{Molecular Ecology Resources} \emph{Accepted pending minor revision} %\href{https://peerj.com/preprints/1472/}{ANGSD-wrapper}
%CITES:0

\item {\bf Beissinger TM}$^\S$, Wang L, {\bf Crosby K}, {\bf Durvasula A}$^\ddagger$, Hufford MB, {\bf Ross-Ibarra J}$^\S$.  Recent demography drives changes in linked selection across the maize genome \textsc{Nature Plants} \emph{In Press}
...
%CITES:5019892223730894925,374365493549966210
...
%CITES:11944729109494726624,8302666039672499689
