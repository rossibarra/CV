...
\item Search committees:
Climate Adaptation%\hfill2017-2019
...
\item Chair, PEQG 2022 Conference%\hfill2022
...
Genes, Genomes, and Genetics (SE, AE)%(AE 2014-2019, SE 2017-2019),
Genetics (Guest) %, 2018),
PLoS Genetics (AE)%(2018-2019),
PeerJ (SE, AE)%(2013-present, SE 2018-2019)
PNAS (Guest) %, 2018)
% eLife (Guest, 2016)
    % axios reviews (2013-2017)
\item Journal peer review: \ignore{10/18,1/19,11/19} eLife (3),  \ignore{9/17} Cell, \ignore{9/17,4/18, 7/19} Nature Communications (3), \ignore{2/19} Nature Reviews Genetics, \ignore{4/18,7/18,8/18} PNAS (3),   \ignore{7/19} Science, \ignore{8/19} PLoS Genetics, \ignore{12/17, 7/19} New Phytologist (2),  \ignore{7/19} Molecular Ecology, G3 (many),  \ignore{9/17} Plant Journal,  \ignore{11/17} Agriculture, Ecosystems and Environment
...
\item Calvin Sperling Memorial Biodiversity Lectureship, Phoenix, 2020
...
\begin{itemize}
\item Xu G, Lyu J, Li Q, Liu H, Wang D, Zhang M, Springer NM, \textbf{Ross-Ibarra J}, Yang J.
Adaptive evolution of DNA methylation reshaped gene regulation in maize doi: 10.1101/2020.03.13.991117
%CITES:0
...
%CITES:3273742166310424316,12651666182337191184
...
%CITES:6345641206578854017,5340742998993614017
...
%CITES:14658936176419871996,405592559232898639,15704659461042961104
