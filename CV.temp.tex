...
\item Hu H, Crow T, Nojoomi S, Schulz, AJ, Hufford MB, Flint-Garcia SF, Sawers RJ, Rell\`{a}n-\`{A}lvarez R, Est\`{e}vez-Palmas JM, \textbf{Ross-Ibarra J}, Runcie DE. Allele-specific expression reveals multiple paths to highland adaptation in maize.
