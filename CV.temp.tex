...
\setlist[itemize]{leftmargin=1.5em,label={},itemsep=0ex,topsep=0.35ex,parsep=0pt,partopsep=0pt}

% Two-column CV row with wrapped left column and right-aligned dates.
% Optional first argument sets the hanging indent of wrapped lines (default 1.5em).
\newcommand{\cvitem}[3][1.5em]{%
  \item\begin{tabularx}{\linewidth}{@{}>{\hangindent=#1\hangafter=1\raggedright\arraybackslash}X@{\hspace{1.5em}}r@{}}
    #2 & #3
  \end{tabularx}%
}
