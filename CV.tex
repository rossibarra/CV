...
%\item Hake S, {\bf Ross-Ibarra J}. The natural history of maize.

%\item Sosso D, Luo D, Li Q-B, Schläpfer J, Gendrot G, Suzuki M, Koch K, McCarty DR, Chourey PS, Rogoswky PM, {\bf Ross-Ibarra J}, Yang B, Frommer WB. Seed filling in domesticated maize and depends on cellular import by SWEET4 hexose transporters.
...
\subsection*{In press or in print} %don't edit below line on H-index, use script instead
 {\small H-Index 25 (2271 citations as of Fri Feb  6 13:40:51 2015)}
...
\item Dyer GA, L\'opez-Feldman A, Y\'unez-Naude A, Taylor JE, {\bf Ross-Ibarra J} (2015) Reply to Brush \emph{et al.}: A wake up call for crop conservation science. PNAS \emph{In Press} (letter).
\\Citations: 0\\
