...
\item Journal peer review: \ignore{10/13,8/13} Nature (2), \ignore {1/14, 3/14} Nature Genetics (2), \ignore{4/14,4/14,8/14,3/13,12/14,5/15} PLoS Genetics (6), \ignore{6/13,7/13,8/13,8/13} PNAS (4), \ignore{1/15} eLife, \ignore{8/13} Current Biology, \ignore{7/13} Genome Research, \ignore{7/14,7/14,5/15} Molecular Biology \& Evolution (3), \ignore{12/14} Genome Biology \& Evolution, \ignore {3/14} American Naturalist, \ignore{1/14,1/15} Molecular Ecology (2), \ignore{2/15} G3, \ignore{1/14} BMC Genomics, \ignore{10/14} BMC Biology, \ignore{4/13,1/15} PLoS ONE (1), \ignore{9/13} Peerage of Science, \ignore{7/13} Scientific Reports 
...
\subsection*{In press or in print} %don't edit below line on H-index, use script instead
 {\small H-Index 26 (2548 citations as of Tue Jun  9 15:50:05 2015)}
