...
%\item Admissions committees: Plant Biology (2013,2015), Population Biology, (2013-2015)
...
\item Journal peer review: \ignore{10/13,8/13} Nature (2), \ignore {1/14, 3/14} Nature Genetics (2), \ignore{4/13} PLoS Biology, \ignore{4/14,4/14,8/14,3/13} PLoS Genetics (4), \ignore{6/13,7/13,8/13,8/13} PNAS (4),\ignore{8/13} Current Biology, \ignore{7/13} Genome Research, \ignore{7/14,7/14} MBE (2), \ignore {3/14} American Naturalist, \ignore{1/14} Molecular Ecology, \ignore{1/14} BMC Genomics, \ignore{10/14} BMC Biology, \ignore{4/13} PLoS ONE, \ignore {3/13} Economic Botany, \ignore{9/13} Peerage of Science, \ignore{7/13} Scientific Reports 
...
\item Dyer GA, L\'opez-Feldman A, Y\'unez-Naude A, Taylor JE, {\bf Ross-Ibarra J}. Reply to Brush \emph{et al.}: A wake up call for crop conservation science. 
...
\subsection*{In press or in print} %don't edit below line on H-index, use script instead
 {\small H-Index 24 (2130 citations as of Tue Dec  2 12:28:35 2014)}

\begin{etaremune}

\item Makarevitch I, Waters M, West P, {\bf Stitzer M}, {\bf Ross-Ibarra, J}, Springer NM (2015) Mobile elements contribute to activation of genes in response to abiotic stress. \textsc{PLoS Genetics} \emph{In Press}. %Preprint: \url{http://biorxiv.org/content/early/2014/08/15/008052}
\\Citations: 0\\
