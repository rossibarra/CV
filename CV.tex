...
\subsection*{In press or in print} %don't edit below line on H-index, use script instead
 {\small H-Index 24 (2174 citations as of Wed Jan  7 07:47:33 2015)}

\begin{etaremune}
\item Dyer GA, L\'opez-Feldman A, Y\'unez-Naude A, Taylor JE, {\bf Ross-Ibarra J}. Reply to Brush \emph{et al.}: A wake up call for crop conservation science. PNAS \emph{In Press} (letter).
\\Citations: 0\\
