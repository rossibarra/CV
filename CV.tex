...
\item Wang Y, Mao R, Liu Y, Guo X, Li N, Zhang Q, Cai M, Xie P, Wang Y, Luo Y, Ding Q, Wu S, Luo E, Ma L, Luo Z, Wei T, Liu H, Dai M, Qiu F, Xiao Y, Yang X, Jackson D, Zhang Z, Yan J$^\S$ , \textbf{Ross-Ibarra J}$^\S$ , Liu L$^\S$ , Yang N$^\S$ . The cellular and genetic basis of inflorescence divergence between maize and teosinte. doi: 10.64898/2026.08.10.743805 [0]\\

\item Ramos-Onsins SE, \textbf{Ross-Ibarra J}, Caceres M, Ferretti L. Bias in diversity estimators and neutrality tests induced by neutral polymorphic structural variants. doi: 10.64898/2026.02.26.708357 [0]\\

\item \textbf{Phillips AR}$^\S$,  AuBuchon-Elder T, Barry K,  Stitzer MC, Buckler ES,  Bukowski R, \textbf{Cameron B},  \textbf{Cryan EP},  Forrestel E, Grabowski PP,  Grimwood J,  Jenkins J, Lipzen AM,  Lovell JT,  Minx P, \textbf{Julianna Porter}$^\ddagger$,  Runcie D,  Schmutz J,  Shu S,  Solomon B,  Stephens J,  Sun Q,  Williams M,  Flint-Garcia S, Romey MC, Kellogg EA, \textbf{Jeffrey Ross-Ibarra}$^\S$. The origins and adaptive consequences of polyploidy in a dominant prairie grass.  doi: 10.1101/2025.11.25.690567v1 [0]\\

\item \textbf{Liu B}, \textbf{Fairbanks RA}, Hirsch CN, Munasinghe M, Pope NS, \textbf{Ross-Ibarra J}$^\S$. Genome-wide selection on transposable elements in maize.  doi: 10.1101/2025.09.16.676665  [2]\\
  
\item O'Donnell DA, \textbf{Yang J}, Zamora P, Lorant A, Miao C, Van Deynze A, Bennett A, \textbf{Ross-Ibarra J}$^\S$. Heritability and QTL mapping of aerial roots and other yield component traits with implications for N2 fication in \textit{Zea mays}.  doi: 10.1101/2025.09.10.675198v1  [1]\\

\item Stitzer MC, Seetharam AS, Scheben A, Hsu S-K, Schulz AJ, AuBuchon-Elder T,   El-Walid M, Ferebee TH, Hale CO,  La T,  Liu Z-Y,  McMorrow SJ,  Minx P, \textbf{Phillips AR},  Syring M,  Wrightsman T,  Zhai J,  Pasquet R,  McAllister C,  Malcomber S,  Traiperm P,  Layton D,  Zhong J,  Costich DE, Dawe RK,  Fengler K,  Harris C,  Irelan Z,  Llaca V,  Parakkal P,  Zastrow-Hayes G,  Woodhouse MR,  Cannon EKS,  Portwood J,  Andorf CM,  Albert PS, Birchler JA,  Siepel A, \textbf{Ross-Ibarra J}, Romay MC,  Kellogg E,  Buckler ES, Hufford MB.  Extensive genome evolution distinguishes maize within a stable tribe of grasses.  doi: 10.1101/2025.01.22.633974   [25]\\

\end{itemize}

%PRINT/PRESS
\subsection*{In press or in print} %don't edit below line on H-index, use script instead
 {\small H-Index 67 (21353 citations as of Thu Sep 17 10:03:04 2026)}

\begin{etaremune}
\setlength\itemsep{0ex}

\item \textbf{Snodgrass S}$^*$, \textbf{Li F}$^*$, \textbf{Mambakkam S}$^\ddagger$, Medina-Mu\~noz SG, \textbf{Sparreo L}$^\ddagger$, \textbf{Menon M}, \textbf{Perez C}$^\ddagger$, Kalsi N, Ghosh AG, Schuster SC, Kim HL, Moreno-Estrada A, Runcie DE, Coop GM, \textbf{Ross-Ibarra J} (2026). Maize genetic diversity is largely unstructured by human ethnolinguistic diversity in its center of origin. \textsc{PNAS} \textit{Accepted} % doi: 10.64898/2026.02.02.703385
{} [0]\\
